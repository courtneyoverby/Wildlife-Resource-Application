          ...
          <div className="grid">
            <div className="grid-col grid-col_8">
              ...
              <p className="landing-p">
                ...
                belong to the state they live in. Wildlife rehabilitation
                centers are organizations that the state and federal governments
                have given permission to provide the care wild animals need when
                they becomes sick or injured.
              </p>

              <p className="landing-p">
                These organizations also aid in disease monitoring! They are
                normally the first ones to learn about disease outbreaks, which
                is very important for disease such as rabies or West Nile Virus-
                both that wildlife can give to people! Want to learn about the
                wildlife rehabilitation centers in Missouri and Kansas? Sign up
                or log in!
              </p>
            </div>
