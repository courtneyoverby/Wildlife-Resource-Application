      ...
      <div className="bg-img-ss">
        <CssBaseline>
          ...
          <div className=" columns">
            ...
            ></img>
            <p className="ss-desc">
              All Things Wild Rehabilitation in Texas were introduced to the
              baby opossums when their mother was hit and killed by a car. Named
              Sting and Trudy after the British musician, they seemed to have no
              trouble growing, continuing to do so until they were lapping
              formula and starting to wean. Then, Sting continued growing, but
              Trudy stopped thriving.
            </p>
            <p className="ss-desc">
